                    ...
                    <div class="card card-span shadow py-4 h-100 border-top border-4 border-primary-1">
                        <div class="card-body">
                            <div class="text-center"><i class="fa fa-cogs fa-2x" aria-hidden="true"></i>
                                ...
                                <p style="font-size: 18px">شرکت ارم صنعت موج گستر با دارا بودن تیمی توانمند از متخصصین و
                    ...
                    <div class="card card-span shadow py-4 h-100 border-top border-4 border-primary-1">
                        <div class="card-body">
                            <div class="text-center"><i class="fa fa-users fa-2x" aria-hidden="true"></i>
                                ...
                                <p style="font-size: 18px">فرهنگ سازمانی شرکت ارم صنعت به گونه‌ای پایه‌گذاری شده است که
                                    تعهد کاری در اولویت
                    ...
                    <div class="card card-span shadow py-4 h-100 border-top border-4 border-primary-1">
                        <div class="card-body">
                            <div class="text-center"><i class="fa fa-handshake fa-2x" aria-hidden="true"></i>
                                ...
                                <p style="font-size: 18px">شرکت ارم صنعت همواره در تلاش است تا با ارائه خدمات تخصصی به
                                    بهترین شکل ممکن،
