...
<body>
    ...
    <main class="main" id="top">
                    ...
                    <section id="home">
                        <div class="bg-holder" style="background-image:url('img/gallery/hero-header.png');background-position:center;background-size:cover;">
                        </div>
                        <!--/.bg-holder-->
                        ...
                        <div class="container">
                            <div class="row align-items-center min-vh-10 min-vh-sm-5">
                                ...
                                <div class="col-md-7 col-lg-6 text-md-start text-center">
                                    ...
                                    <p class="text-light">دانش بنیان</p><a class="btn btn-outline-secondary" href="#" role="button">پروژه ها</a>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="py-0 py-xxl-6" id="help">
                        <div class="bg-holder" style="background-image:url(img/gallery/footer-bg.png);background-position:center;background-size:cover;">
                        </div>
                        <!--/.bg-holder-->
                            ...
                            <div class="row min-vh-75 min-vh-xl-50 pt-10 text-white">
                                ...
                                <div class="col-6 col-md-4 col-xl-4 mb-3">
                                    ...
                                    <ul class="list-unstyled mb-md-4 mb-lg-0">
                                        <li class="lh-lg"><p>شیراز - شهرک آرین - خ فناوری - پارک علم و فناوری فارس - ساختمان تخت جمشید - واحد 3010</p>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="row flex-center pb-3">
                                    <div class="col-md-6 order-0">
                                        <p class="text-200 text-center text-md-start">Copyright &copy; esmg.co.ir 2021 - Powered by <a href="https://fourpluse.ir" target="_blank">fourpluse.ir</p>
                                        </div>
                                    </div>
                                </div>
                            </section>
