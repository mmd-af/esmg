                                ...
                                <div class="project-details-content quickview-content">
                                    <h2 class="text-right mb-4">
                                        <img class="card-img-small"
                                             src="{{ url('/upload/projects/' . $project->logo_image) }}" alt=""/>
                                    ...
                                    <div class="pro-details-meta">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="{{ url('/upload/projects/' . $project->customer_image) }}"
                                                   data-lightbox="image-1"><img class="card-img-small"
                                                                                src="{{ url('/upload/projects/' . $project->customer_image) }}"
                                                                                alt=""/></a>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="col-md-5 col-sm-12 col-xs-12">
                                <div class="tab-content quickview-big-img">
                                    <div id="pro-primary-{{$project->id}}" class="tab-pane fade show active">
                                        <img src="{{ url('/upload/projects/' . $project->primary_image) }}"
                                             width="300px" alt=""/>
                                    </div>
                                    @foreach ($project->images as $image)
                                        <div id="pro-{{$image->id}}" class="tab-pane fade">
                                            <img width="300px" src="{{ url('/upload/projects/' . $image->image) }}"
                                                 alt=""/>
                                        </div>
                                    @endforeach
                                </div>
                                    ...
                                    <div class="quickview-slide-active owl-carousel nav nav-style-2" role="tablist">
                                        ...
                                        @foreach ($project->images as $image)
                                            <a data-toggle="tab" href="#pro-{{$image->id}}">
                                                <img class="card-img-small"
                                                     src="{{ url('/upload/projects/' . $image->image) }}" alt=""/>
                                            </a>
                                        @endforeach
                                    </div>
                                </div>
